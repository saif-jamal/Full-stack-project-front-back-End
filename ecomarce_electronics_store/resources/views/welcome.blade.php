...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body >
        <div class="flex-center position-ref full-height">
            @if (Route::has('login'))
                <div class="top-right links " style="z-index: 2000">
                    @auth
                        <a href="{{ url('/dashboard') }}" style=" color: white;font-size: 26px;">Dashboard</a>
                    @else
        ...
        <span id="music_button" class="material-icons  eq fa-5x " style="color: rgb(52,33,68);cursor: pointer;">play_arrow</span>

        <div class="div________">

        </div>
        <div class="eq " style="--n: 36; --f: 11.43">
            <div class="bar" style="--k: 0; --t: 0.52s; --dt: -0.38s; --tx: 23%"></div>
            <div class="bar" style="--k: 1; --t: 2.31s; --dt: -0.75s; --tx: 67%"></div>
            <div class="bar" style="--k: 2; --t: 0.55s; --dt: -0.28s; --tx: 57%"></div>
            <div class="bar" style="--k: 3; --t: 1.4s; --dt: -0.07s; --tx: 4%"></div>
            <div class="bar" style="--k: 4; --t: 2.01s; --dt: -0.03s; --tx: 5%"></div>
            <div class="bar" style="--k: 5; --t: 0.93s; --dt: -0.49s; --tx: 78%"></div>
            <div class="bar" style="--k: 6; --t: 1.53s; --dt: -1.53s; --tx: 24%"></div>
            <div class="bar" style="--k: 7; --t: 0.63s; --dt: -0.14s; --tx: 2%"></div>
            <div class="bar" style="--k: 8; --t: 1.35s; --dt: -0.27s; --tx: 70%"></div>
            <div class="bar" style="--k: 9; --t: 0.65s; --dt: -0.08s; --tx: 34%"></div>
            <div class="bar" style="--k: 10; --t: 2.39s; --dt: -1.57s; --tx: 25%"></div>
            <div class="bar" style="--k: 11; --t: 1.76s; --dt: -0.85s; --tx: 31%"></div>
            <div class="bar" style="--k: 12; --t: 1.35s; --dt: -1.34s; --tx: 17%"></div>
            <div class="bar" style="--k: 13; --t: 1.71s; --dt: -1.53s; --tx: 19%"></div>
            <div class="bar" style="--k: 14; --t: 1.74s; --dt: -1.21s; --tx: 24%"></div>
            <div class="bar" style="--k: 15; --t: 1.98s; --dt: -0.43s; --tx: 65%"></div>
            <div class="bar" style="--k: 16; --t: 0.92s; --dt: -0.62s; --tx: 4%"></div>
            <div class="bar" style="--k: 17; --t: 1.31s; --dt: -0.5s; --tx: 12%"></div>
            <div class="bar" style="--k: 18; --t: 0.8s; --dt: -0.79s; --tx: 0%"></div>
            <div class="bar" style="--k: 19; --t: 1.5s; --dt: -0.21s; --tx: 8%"></div>
            <div class="bar" style="--k: 20; --t: 0.78s; --dt: -0.31s; --tx: 10%"></div>
            <div class="bar" style="--k: 21; --t: 2.49s; --dt: -0.99s; --tx: 56%"></div>
            <div class="bar" style="--k: 22; --t: 1.3s; --dt: -0.27s; --tx: 38%"></div>
            <div class="bar" style="--k: 23; --t: 1.32s; --dt: -0.7s; --tx: 40%"></div>
            <div class="bar" style="--k: 24; --t: 1.84s; --dt: -0.05s; --tx: 46%"></div>
            <div class="bar" style="--k: 25; --t: 1.36s; --dt: -1.36s; --tx: 45%"></div>
            <div class="bar" style="--k: 26; --t: 1.89s; --dt: -0.73s; --tx: 1%"></div>
            <div class="bar" style="--k: 27; --t: 0.56s; --dt: -0.41s; --tx: 33%"></div>
            <div class="bar" style="--k: 28; --t: 0.62s; --dt: -0.6s; --tx: 13%"></div>
            <div class="bar" style="--k: 29; --t: 1.13s; --dt: -0.19s; --tx: 21%"></div>
            <div class="bar" style="--k: 30; --t: 0.64s; --dt: -0.34s; --tx: 8%"></div>
            <div class="bar" style="--k: 31; --t: 2.15s; --dt: -1.92s; --tx: 7%"></div>
            <div class="bar" style="--k: 32; --t: 0.91s; --dt: -0.79s; --tx: 6%"></div>
            <div class="bar" style="--k: 33; --t: 0.55s; --dt: -0.05s; --tx: 25%"></div>
            <div class="bar" style="--k: 34; --t: 1.47s; --dt: -1.01s; --tx: 15%"></div>
            <div class="bar" style="--k: 35; --t: 0.71s; --dt: -0.33s; --tx: 15%"></div>
        </div>

        <audio id="musicplayer" class="d-none" controls loop="loop"  >
            <source src="{{asset('music/001.mp3')}}" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>

        <script>
            const musicplayer=document.getElementById('music_button');

            const musicplayer_sound=document.getElementById('musicplayer');
            var count_music=0;
            ...
            window.addEventListener("mouseover", event => {
                ...
                if(booleancheck==false){
                    musicplayer_sound.volume = 0.2;
                    document.getElementById('musicplayer').play();
                    musicplayer.innerHTML="pause";
                }
            ...
            musicplayer.addEventListener('click',(e)=>{
                musicplayer_sound.volume = 0.2;
                if(count_music==0){
                    musicplayer.innerHTML="play_arrow";
                    musicplayer_sound.pause();
                    count_music=1;
                    booleancheck=true;
                }
                else if(count_music==1){
                    musicplayer.innerHTML="pause";
                    musicplayer_sound.play();
                    count_music=0;
                    booleancheck=true;
            ...
            @if(\Illuminate\Support\Facades\Session::has('user_not_admin'))
                <script>
                    swal("Warning💥","This account is not allowed to access this page","error",{
                        button:"OK",
                    });
                </script>
            @endif
