                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-10 my-3">
                        ...
                        <div class="card bg__change p-4 overflow-hidden">
                            <h1 class="white___chang my-4">Category Information</h1>
                            @if($errors->any())
                            ...
                            <form method="post" action="{{route('create_product')}}" enctype="multipart/form-data">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="form-outline mb-4">
                                        <div class="ms-5 cat__img d-flex justify-content-center align-items-center fa-3x bg__change_____formproduct rounded-3 " id="add_img_button" title="upload image"><span class="material-icons white___chang">add</span></div>
                                    ...
                                    <!-- Name english input -->
                                    <div class="form-outline mb-4">
                                        <input type="text" id="form4Example1" class="form-control   bg__change_____formproduct" name="categgoryname_en" />
                                        <label class="form-label text-dark white___chang" for="form4Example1">Category Name</label>
                                    </div>

                                    <!-- Name arabic input -->
                                    <div class="form-outline mb-4">
                                        <input type="text" id="form4Example1" class="form-control  bg__change_____formproduct " name="categgoryname_ar" />
                                    ...
                                    <div class="form-outline mb-4">
                                        <textarea class="form-control  bg__change_____formproduct " id="form4Example3" rows="4" name="categorydescriptions_en"></textarea>
                                        <label class="form-label text-dark white___chang" for="form4Example3">Descriptions Category</label>
                                    </div>

                                    <!-- descriptions arabic input -->
                                    <div class="form-outline mb-4">
                                        <textarea class="form-control  bg__change_____formproduct" id="form4Example3" rows="4" name="categorydescriptions_ar" ></textarea>
                                        <label class="form-label text-dark white___chang" for="form4Example3">وصف الفئة</label>
                                    </div>


                                    <!-- Submit button -->
                                    <button type="submit" class="btn btn-dark   mb-4">Create Category</button>
                                </div>
                            </form>
                        </div>
