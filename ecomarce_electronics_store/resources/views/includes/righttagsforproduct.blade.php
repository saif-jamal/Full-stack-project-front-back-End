                        ...
                        <div class="card bg__change p-0 m-0 rounded-2">
                            ...
                            <div class="row p-4 overflow-hidden" id="img_slider_add_display" >
                                ...
                                <div class="col-md-12 p-4">
                                    <h1 class="white___chang">Add some Tags for Your Product</h1>
                                    <p class="white___chang my-5 pt-3 img____">You can add multiple tags</p>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="p-4">
                                        @if(\Illuminate\Support\Facades\Session::has('new_tags_for_product'))
                                            <form method="post" class="d-flex" action="{{route('creattagsforproduct')}}">
                                                @csrf
                                                <!-- Name english input -->
                                                ...
                                                <div class="form-outline mb-4 mx-2">
                                                    <input type="submit" value="Add" id="addtag" name="addtag" class="btn btn-dark text-white">
                                                </div>
                                            </form>
                                        @else
                                            <form method="post" class="d-flex" action="{{route('creattagsforproduct')}}">
