...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent mt-4">
    <div class="container">
        <a href="/" class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="">
           E-Ecommerce Electronics store Dashboard
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2" href="{{route('registerCustome')}}">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2" href="{{route('loginCustom')}}">
                ...
                <div class="card z-index-0">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" role="form text-left">
                            ...
                            <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{route('loginCustom')}}" class="text-dark font-weight-bolder">Sign in</a></p>
                        </form>
                    </div>
